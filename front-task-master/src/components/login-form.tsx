...
export function LoginForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMsg = err.response?.data?.message || "Credenciales inválidas. Por favor, intenta de nuevo."
      setError(errorMsg)
          ...
          <form className="p-6 md:p-8" onSubmit={handleSubmit}>
            <FieldGroup>
              ...
              <Field className="pt-2">
                <Button type="submit" disabled={loading} className="w-full py-6 font-bold text-base shadow-lg shadow-primary/20">
