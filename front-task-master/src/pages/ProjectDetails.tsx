...
import { TaskVisitorPanel } from '@/components/task-visitor-panel';
        ...
        >
          <div className="flex items-center justify-between">
            <TabsList className="bg-muted/50 p-1">
              ...
              <TabsTrigger value="visitor" className="data-[state=active]:bg-background data-[state=active]:shadow-sm">
                Análisis
              </TabsTrigger>
            </TabsList>
          ...
          {/* Visitor — Análisis del árbol de tareas */}
          <TabsContent value="visitor" className="flex-1 mt-4 outline-none">
            <div className="p-2">
              <TaskVisitorPanel projectId={project._id} />
            </div>
          </TabsContent>
        </Tabs>
      ) : (
